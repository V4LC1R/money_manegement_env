...
const Schema: z.ZodType<Prisma.FinancialTransactionCreateNestedManyWithoutAccountInput> =
  z
    .object({
      create: z
        .union([
...
export const FinancialTransactionCreateNestedManyWithoutAccountInputObjectSchema =
  Schema;
