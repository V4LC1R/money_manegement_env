...
const Schema: z.ZodType<Prisma.AccountUncheckedUpdateManyWithoutCategoryNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const AccountUncheckedUpdateManyWithoutCategoryNestedInputObjectSchema =
  Schema;
