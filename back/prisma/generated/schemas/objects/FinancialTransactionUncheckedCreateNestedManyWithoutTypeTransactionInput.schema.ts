...
const Schema: z.ZodType<Prisma.FinancialTransactionUncheckedCreateNestedManyWithoutTypeTransactionInput> =
  z
    .object({
      create: z
        .union([
...
export const FinancialTransactionUncheckedCreateNestedManyWithoutTypeTransactionInputObjectSchema =
  Schema;
