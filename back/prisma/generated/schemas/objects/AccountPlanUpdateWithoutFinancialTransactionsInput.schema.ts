...
const Schema: z.ZodType<Prisma.AccountPlanUpdateWithoutFinancialTransactionsInput> =
  z
    .object({
      name: z
        .union([
...
export const AccountPlanUpdateWithoutFinancialTransactionsInputObjectSchema =
  Schema;
