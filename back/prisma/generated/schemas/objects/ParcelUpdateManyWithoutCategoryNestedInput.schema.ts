...
const Schema: z.ZodType<Prisma.ParcelUpdateManyWithoutCategoryNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => ParcelUpdateManyWithWhereWithoutCategoryInputObjectSchema),
        z
          .lazy(() => ParcelUpdateManyWithWhereWithoutCategoryInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const ParcelUpdateManyWithoutCategoryNestedInputObjectSchema = Schema;
