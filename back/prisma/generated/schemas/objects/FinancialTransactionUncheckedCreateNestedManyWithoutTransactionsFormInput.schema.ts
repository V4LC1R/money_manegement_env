...
const Schema: z.ZodType<Prisma.FinancialTransactionUncheckedCreateNestedManyWithoutTransactionsFormInput> =
  z
    .object({
      create: z
        .union([
...
export const FinancialTransactionUncheckedCreateNestedManyWithoutTransactionsFormInputObjectSchema =
  Schema;
