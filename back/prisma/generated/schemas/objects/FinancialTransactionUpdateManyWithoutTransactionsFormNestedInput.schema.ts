...
const Schema: z.ZodType<Prisma.FinancialTransactionUpdateManyWithoutTransactionsFormNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const FinancialTransactionUpdateManyWithoutTransactionsFormNestedInputObjectSchema =
  Schema;
