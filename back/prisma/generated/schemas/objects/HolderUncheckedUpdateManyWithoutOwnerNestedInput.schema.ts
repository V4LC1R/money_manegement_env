...
const Schema: z.ZodType<Prisma.HolderUncheckedUpdateManyWithoutOwnerNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => HolderUpsertWithWhereUniqueWithoutOwnerInputObjectSchema,
          ),
          z
            .lazy(
              () => HolderUpsertWithWhereUniqueWithoutOwnerInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => HolderUpdateWithWhereUniqueWithoutOwnerInputObjectSchema,
          ),
          z
            .lazy(
              () => HolderUpdateWithWhereUniqueWithoutOwnerInputObjectSchema,
...
export const HolderUncheckedUpdateManyWithoutOwnerNestedInputObjectSchema =
  Schema;
