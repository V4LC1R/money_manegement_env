...
const Schema: z.ZodType<Prisma.TransactionsFormsUncheckedUpdateWithoutHolderInput> =
  z
    .object({
      id: z
        .union([
...
export const TransactionsFormsUncheckedUpdateWithoutHolderInputObjectSchema =
  Schema;
