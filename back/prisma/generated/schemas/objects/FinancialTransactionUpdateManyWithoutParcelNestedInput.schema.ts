...
const Schema: z.ZodType<Prisma.FinancialTransactionUpdateManyWithoutParcelNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const FinancialTransactionUpdateManyWithoutParcelNestedInputObjectSchema =
  Schema;
