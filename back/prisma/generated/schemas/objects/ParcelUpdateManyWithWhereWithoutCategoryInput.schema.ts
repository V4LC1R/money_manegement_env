...
const Schema: z.ZodType<Prisma.ParcelUpdateManyWithWhereWithoutCategoryInput> =
  z
    .object({
...
export const ParcelUpdateManyWithWhereWithoutCategoryInputObjectSchema = Schema;
