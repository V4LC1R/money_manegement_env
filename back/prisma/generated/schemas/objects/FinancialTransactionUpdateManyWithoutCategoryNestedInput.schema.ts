...
const Schema: z.ZodType<Prisma.FinancialTransactionUpdateManyWithoutCategoryNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const FinancialTransactionUpdateManyWithoutCategoryNestedInputObjectSchema =
  Schema;
