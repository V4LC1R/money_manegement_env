...
const Schema: z.ZodType<Prisma.FinancialTransactionCreateWithoutAccountInput> =
  z
    .object({
...
export const FinancialTransactionCreateWithoutAccountInputObjectSchema = Schema;
