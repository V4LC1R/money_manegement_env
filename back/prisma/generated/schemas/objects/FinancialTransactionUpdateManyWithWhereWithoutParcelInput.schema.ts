...
const Schema: z.ZodType<Prisma.FinancialTransactionUpdateManyWithWhereWithoutParcelInput> =
  z
    .object({
...
export const FinancialTransactionUpdateManyWithWhereWithoutParcelInputObjectSchema =
  Schema;
