...
const Schema: z.ZodType<Prisma.AccountUncheckedCreateNestedManyWithoutCategoryInput> =
  z
    .object({
      create: z
        .union([
...
export const AccountUncheckedCreateNestedManyWithoutCategoryInputObjectSchema =
  Schema;
