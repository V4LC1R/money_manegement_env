...
const Schema: z.ZodType<Prisma.FinancialTransactionUpdateManyWithoutTypeTransactionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const FinancialTransactionUpdateManyWithoutTypeTransactionNestedInputObjectSchema =
  Schema;
