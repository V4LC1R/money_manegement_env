...
const Schema: z.ZodType<Prisma.FinancialTransactionUpdateManyWithWhereWithoutAccountInput> =
  z
    .object({
...
export const FinancialTransactionUpdateManyWithWhereWithoutAccountInputObjectSchema =
  Schema;
