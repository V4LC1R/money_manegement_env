...
const Schema: z.ZodType<Prisma.TransactionsFormsUpdateManyWithoutHolderNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const TransactionsFormsUpdateManyWithoutHolderNestedInputObjectSchema =
  Schema;
