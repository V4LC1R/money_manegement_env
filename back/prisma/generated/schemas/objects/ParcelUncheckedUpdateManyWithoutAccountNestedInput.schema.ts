...
const Schema: z.ZodType<Prisma.ParcelUncheckedUpdateManyWithoutAccountNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => ParcelUpdateManyWithWhereWithoutAccountInputObjectSchema,
          ),
          z
            .lazy(
              () => ParcelUpdateManyWithWhereWithoutAccountInputObjectSchema,
...
export const ParcelUncheckedUpdateManyWithoutAccountNestedInputObjectSchema =
  Schema;
