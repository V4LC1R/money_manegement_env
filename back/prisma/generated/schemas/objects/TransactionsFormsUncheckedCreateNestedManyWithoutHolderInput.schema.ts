...
const Schema: z.ZodType<Prisma.TransactionsFormsUncheckedCreateNestedManyWithoutHolderInput> =
  z
    .object({
      create: z
        .union([
...
export const TransactionsFormsUncheckedCreateNestedManyWithoutHolderInputObjectSchema =
  Schema;
