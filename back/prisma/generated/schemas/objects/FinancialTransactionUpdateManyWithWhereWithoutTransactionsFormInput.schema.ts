...
const Schema: z.ZodType<Prisma.FinancialTransactionUpdateManyWithWhereWithoutTransactionsFormInput> =
  z
    .object({
...
export const FinancialTransactionUpdateManyWithWhereWithoutTransactionsFormInputObjectSchema =
  Schema;
