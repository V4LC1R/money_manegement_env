...
const Schema: z.ZodType<Prisma.FinancialTransactionCreateWithoutTransactionsFormInput> =
  z
    .object({
...
export const FinancialTransactionCreateWithoutTransactionsFormInputObjectSchema =
  Schema;
