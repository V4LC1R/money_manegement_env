...
const Schema: z.ZodType<Prisma.FinancialTransactionUncheckedCreateNestedManyWithoutCategoryInput> =
  z
    .object({
      create: z
        .union([
...
export const FinancialTransactionUncheckedCreateNestedManyWithoutCategoryInputObjectSchema =
  Schema;
