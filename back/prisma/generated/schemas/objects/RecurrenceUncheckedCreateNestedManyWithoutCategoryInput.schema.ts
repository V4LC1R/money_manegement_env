...
const Schema: z.ZodType<Prisma.RecurrenceUncheckedCreateNestedManyWithoutCategoryInput> =
  z
    .object({
      create: z
        .union([
...
export const RecurrenceUncheckedCreateNestedManyWithoutCategoryInputObjectSchema =
  Schema;
