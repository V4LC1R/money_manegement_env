...
const Schema: z.ZodType<Prisma.ParcelUpdateWithoutFinancialTransactionsInput> =
  z
    .object({
      value: z
        .union([
      ...
      account: z
        .lazy(
          () => AccountUpdateOneRequiredWithoutParcelsNestedInputObjectSchema,
        )
        .optional(),
    })
    .strict();

export const ParcelUpdateWithoutFinancialTransactionsInputObjectSchema = Schema;
