...
const Schema: z.ZodType<Prisma.FinancialTransactionUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const FinancialTransactionUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
