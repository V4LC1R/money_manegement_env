...
const Schema: z.ZodType<Prisma.FinancialTransactionUpdateManyWithoutAccountNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const FinancialTransactionUpdateManyWithoutAccountNestedInputObjectSchema =
  Schema;
