...
const Schema: z.ZodType<Prisma.FinancialTransactionUncheckedCreateNestedManyWithoutParcelInput> =
  z
    .object({
      create: z
        .union([
...
export const FinancialTransactionUncheckedCreateNestedManyWithoutParcelInputObjectSchema =
  Schema;
